...
(function($) {
    $.fn.ajaddress = function(settings) {
        ...
        let _settings = $.extend(_defaultSettings, settings);
        let _handler = function() {

            //init
            let container = this;
            let countyCount = $(".county option", container).length;
            let city = $(".city", container);
            let county = $(".county", container);
            let zipcode = $(".zipcode", container);
            ...
            city.change(function() {
                ...
                let selectIndex = $('option:selected', this).index();
                let selectText = $('option:selected', this).text();
            ...
            county.change(function() {
                let citySelectText = city.children("option:selected").text();
                let countySelectText = $("option:selected", this).text();
